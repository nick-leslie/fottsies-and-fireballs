...
export function draw_texture_pro(
  texture,
  source,
  dest,
  pos_x,
...
//--- gui
export function gui_button(rectangle, txt) {
  r.GuiButton(rectangle, txt);
}

export function gui_textbox(rectangle, txt, txt_size, edit_mode) {
  r.GuiTextBox(rectangle, txt, txt_size, edit_mode);
}
